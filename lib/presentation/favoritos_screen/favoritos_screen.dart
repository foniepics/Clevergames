...
class FavoritosScreen extends GetWidget<FavoritosController> {
  @override
            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                    child: Column(
                      ...
                      Padding(
                          padding: getPadding(left: 18, top: 26, right: 18),
                          child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                ...
                                CommonImageView(
                                    svgPath: ImageConstant.imgFavorite28x28,
